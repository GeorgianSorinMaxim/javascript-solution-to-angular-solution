...
myApp.controller("indexController", function($scope, $location, Data) {
  ...
  // The data can be loaded in the Angular controller using $http GET requests, see the commented code below.
  // For the purposes of this exercise, the data will be created as objects in this file.
  // Data.getFilterGroups()
  // .success(function(data) {
  //   $scope.refinements = data;
  // });
